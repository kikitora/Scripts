...
namespace SteraCube.SpaceJourney.LifeEvents
{
    ...
    public static class Knight_Events
    {
        ...
        private static IEnumerable<ReinLifeEvent> Jieitai()
        {
            ...
            {
                eventId = "ev_jdf_r1b",
                learnsSkillId = "knight_jieitai_s1",
                sentence = "演習で班を率いた。",
                startAge = 25,
                endAge = 55,
                baseWeight = 1.0f,
            ...
            {
                eventId = "ev_jdf_r3b",
                learnsSkillId = "knight_jieitai_s2",
        ...
        private static IEnumerable<ReinLifeEvent> Kyumei()
        {
            ...
            {
                eventId = "ev_emt_r1b",
                learnsSkillId = "knight_kyumei_s1",
            ...
            {
                eventId = "ev_emt_r3b",
                learnsSkillId = "knight_kyumei_s2",
        ...
        private static IEnumerable<ReinLifeEvent> Bodyguard()
        {
            ...
            yield return new ReinLifeEvent
            {
                ...
                learnsSkillId = "knight_bodyguard_s1",
            ...
            yield return new ReinLifeEvent
            {
                ...
                learnsSkillId = "knight_bodyguard_s2",
        ...
        private static IEnumerable<ReinLifeEvent> Saiban()
        {
            ...
            yield return new ReinLifeEvent
            {
                ...
                learnsSkillId = "knight_saiban_s1",
            ...
            yield return new ReinLifeEvent
            {
                ...
                learnsSkillId = "knight_saiban_s2",
        ...
        private static IEnumerable<ReinLifeEvent> Bengoshi()
        {
            ...
            {
                eventId = "ev_intl_r3b",
                learnsSkillId = "knight_bengoshi_s1",
            ...
            {
                eventId = "ev_intl_r7b",
                learnsSkillId = "knight_bengoshi_s2",
