...
namespace SteraCube.SpaceJourney.LifeEvents
{
    ...
    public static class Lancer_Events
    {
        ...
        private static IEnumerable<ReinLifeEvent> Ryoshi()
        {
            ...
            {
                eventId = "ev_ryo_r1b",
                learnsSkillId = "lancer_ryoshi_s1",
            ...
            {
                eventId = "ev_ryo_r3b",
                learnsSkillId = "lancer_ryoshi_s2",
        ...
        private static IEnumerable<ReinLifeEvent> Tatekiya()
        {
            ...
            {
                eventId = "ev_coll_r1b",
                learnsSkillId = "lancer_tatekiya_s1",
            ...
            {
                eventId = "ev_coll_r3b",
                learnsSkillId = "lancer_tatekiya_s2",
        ...
        private static IEnumerable<ReinLifeEvent> Haikan()
        {
            ...
            yield return new ReinLifeEvent
            {
                ...
                learnsSkillId = "lancer_haikan_s1",
            ...
            yield return new ReinLifeEvent
            {
                ...
                learnsSkillId = "lancer_haikan_s2",
        ...
        private static IEnumerable<ReinLifeEvent> Kussaku()
        {
            ...
            {
                eventId = "ev_kuss_r3b",
                learnsSkillId = "lancer_kussaku_s1",
            ...
            yield return new ReinLifeEvent
            {
                ...
                learnsSkillId = "lancer_kussaku_s2",
        ...
        private static IEnumerable<ReinLifeEvent> Kigyoka()
        {
            ...
            {
                eventId = "ev_ent_r3b",
                learnsSkillId = "lancer_kigyoka_s1",
            ...
            yield return new ReinLifeEvent
            {
                ...
                learnsSkillId = "lancer_kigyoka_s2",
        ...
        private static IEnumerable<ReinLifeEvent> Rocket()
        {
            ...
            yield return new ReinLifeEvent
            {
                ...
                learnsSkillId = "lancer_rocket_s1",
            ...
            yield return new ReinLifeEvent
            {
                ...
                learnsSkillId = "lancer_rocket_s2",
                sentence = "自分が設計に関わったロケットが、初めて有人飛行に成功した。",
                startAge = 28,
                endAge = 58,
                baseWeight = 1.0f,
                requireMinRank = 7,
